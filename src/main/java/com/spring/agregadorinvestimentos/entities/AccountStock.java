...
public class AccountStock {
	...
	@ManyToOne
	@MapsId("accountId") //Nome do Id mapeado da entidade Account na classe AccountStockId
	@JoinColumn(name = "account_id")
	private Account account;
	
	@ManyToOne
	@MapsId("stockId") //Nome do Id mapeado da entidade Stock na classe AccountStockId
